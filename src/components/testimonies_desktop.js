...
import CixStudioPFP from "../assets/client_carmen_(cix_studio).svg";
import AgrowPFP from "../assets/client_antonella_(agrow).svg";
import SentrisensePFP from "../assets/client_sebastian_(sentrisense).svg";
